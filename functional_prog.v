...
(* 000...0[len as 64-bit representation] *)
...
(* TODO 
read this
figure out this difference between the two SHAs
*)
...
f_equal.
rewrite <- generate_and_pad'_eq. (* TODO look at this eq proof *)
assert (16 | Zlength (generate_and_pad msg)).
rewrite (length_generate_and_pad msg). (* look at the various l_gaps TODO *)
apply roundup_divide; omega.
assert (length init_registers = 8%nat) by reflexivity.
forget init_registers as regs.
forget (generate_and_pad msg) as blocks.
apply process_msg_hash_blocks; auto. (* TODO look at this equivalence *)
Check process_msg_hash_blocks.
Qed.