...
% TODO wouldn't this work fine with the convert function instead??
% The strength of the inductive relation $\approx_i$ is that it allows us to naturally break up a large $bytes\_bits\_lists$ proof into a proof involving several smaller $bytes\_bits\_lists$ proofs on inner arguments. That is, it is "propositionally compositional" or "backward compositional."
