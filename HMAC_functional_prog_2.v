...
(* TODO: changed SHA256 to SHA256' *)
Module SHA256_ <: HASH_FUNCTION.
  Definition BlockSize:= 64%nat. (* proof of correct block size and digest size? *)
  Definition DigestLength:= 32%nat.
  Definition Hash : list Z -> list Z := SHA_256'.
End SHA256_.

(*
Error: The field BlockSize is missing in Top.SHA256.
Error: The field BlockSize is missing in SHA256
TODO: maybe SHA256 (the spec) was updated
  *)
(* Error: "Top.SHA256" is not a module. *)
Module HMAC_SHA256 := HMAC_FUN SHA256_. (* why Top.? *)
